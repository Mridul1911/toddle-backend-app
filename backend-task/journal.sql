...
CREATE TABLE journal(
    ...
    published_by INTEGER, FOREIGN KEY(published_by) REFERENCES teacher(t_id)
);
...
ALTER TABLE `tagged` DROP FOREIGN KEY `tagged_ibfk_1`; ALTER TABLE `tagged` ADD CONSTRAINT `tagged_ibfk_1` 
